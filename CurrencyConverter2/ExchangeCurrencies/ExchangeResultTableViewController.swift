...
//        getExchangeRates()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as? PopulateTableViewCell else { fatalError("Some Error")}
        
   

        let rateValue = self.currencies[indexPath.row]
